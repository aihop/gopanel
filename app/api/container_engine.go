...
// @Security ApiKeyAuth
// @Security Timestamp
// @Router /container/engine/status [get]
func ContainerEngineStatus(c fiber.Ctx) error {
...
// @Security ApiKeyAuth
// @Security Timestamp
// @Router /container/engine/file [get]
func ContainerEngineFile(c fiber.Ctx) error {
	resolved := udocker.ResolveRuntime(context.Background())
	c.Set("X-Container-Runtime", string(resolved.Kind))
	c.Set("X-Container-Runtime-Host", resolved.Host)
...
// @Security ApiKeyAuth
// @Security Timestamp
// @Router /container/engine/config [get]
func ContainerEngineConfig(c fiber.Ctx) error {
