...
<template>
  <n-form-item label="产物操作" path="actionType" v-if="formModel.buildEnv === 'host'">
    <n-radio-group v-model:value="formModel.actionType">
      <n-space vertical>
        ...
        <n-radio value="deploy">部署产物到网站 (Deploy)</n-radio>
        <div class="ml-6 text-xs text-slate-500">将产物目录 (如 dist/) 同步到已关联本流水线的网站并生效</div>
