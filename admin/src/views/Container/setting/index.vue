	...
	<div>
		...
		<div class="bg-base-100 mt-8 rounded-[28px] p-8 shadow">
			<n-tabs type="line" animated @update:value="handleTabChange">
				...
				<n-tab-pane name="advanced" tab="全部配置">
		...
		<DockerDrawer ref="DockerDrawerModel" @save="getDaemon" />
		<LogDrawer ref="logDrawerRef" @search="getDaemon" />
		<RebootAlert ref="rebootIptablesRef" @confirm="handleIptablesConfirmLocal" />
		<RebootAlert ref="rebootLiveRestoreRef" @confirm="handleLiveRestoreConfirmLocal" />
		<RebootAlert ref="rebootCgroupRef" @confirm="handleCgroupConfirmLocal" />
