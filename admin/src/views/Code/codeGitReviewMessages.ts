export const codeGitReviewMessages = {
	zh: {
		code: {
			...
			gitMultiMergeConfirm: "确认依次合并 {count} 个仓库？系统会逐仓库记录结果，发生冲突时停止并保留未完成工作区。",
	...
	en: {
		code: {
			...
			gitMultiMergeConfirm: "Merge {count} repositories in sequence? Each result is persisted, and conflicts stop delivery while unfinished worktrees are preserved.",
