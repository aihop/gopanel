...
<template>
  <!--
	...
	-->
  <div
    class="task-meta-line flex min-w-0 items-center gap-1.5 overflow-hidden whitespace-nowrap text-[10px] text-slate-400"
    :title="taskTooltip(task)"
  >
    <slot name="lead" />
    <template v-if="taskDeliveryMeta(task)">
      <span class="meta-separator text-slate-300">·</span>
      <span
...
<style scoped>
.task-meta-line > .meta-separator:first-child {
	display: none;
}
</style>
