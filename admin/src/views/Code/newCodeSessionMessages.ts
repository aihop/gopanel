...
const providerMessages = {
	zh: {
		...
		providerSavedAccount: "选择已保存账号",
		providerManual: "手动填写",
		providerAccount: "AI 账号",
		providerAccountPlaceholder: "请选择本会话使用的 AI 账号",
		providerAccountRequired: "请选择 AI 账号",
		providerAccountLoadFailed: "AI 账号加载失败",
		providerAccountEmpty: "暂无可用 AI 账号，可手动填写或前往系统设置添加",
	...
	en: {
		...
		providerSavedAccount: "Use saved account",
		providerManual: "Enter manually",
		providerAccount: "AI account",
		providerAccountPlaceholder: "Select an AI account for this session",
		providerAccountRequired: "Select an AI account",
		providerAccountLoadFailed: "Failed to load AI accounts",
		providerAccountEmpty: "No available AI accounts. Enter the connection manually or add one in Settings.",
