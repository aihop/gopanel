...
export const getDBManagerTableDataAPI = (data: { serverId: number; databaseName: string; tableName: string; page: number; pageSize: number; searchColumn?: string; searchValue?: string; advancedSearch?: any[] }) => {
