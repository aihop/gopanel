...
type FormItemRule = any
const checkNoSpace = (rule: any, value: any, callback: any) => {
	if (value.indexOf(" ") !== -1) {
		return callback(new Error(t("setting.noSpace")))
	}
	callback()
}
...
const checkHost = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		...
		if (!regIP.test(value) && !regHost.test(value)) {
			callback(new Error(t("commons.rule.host")))
		} else {
			callback()
		}
	}
...
const checkIllegal = (rule: any, value: any, callback: any) => {
	...
	if (
		...
		callback(new Error(t("commons.rule.illegalInput")))
	} else {
		callback()
	}
}
...
const complexityPassword = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.complexityPassword")))
	} else {
...
const checkName = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.commonName")))
	} else {
...
const checkUserName = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.userName")))
	} else {
...
const checkSimpleName = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.simpleName")))
	} else {
...
const checkSimplePassword = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.simplePassword")))
	} else {
...
const checkDBName = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.dbName")))
	} else {
...
const checkImageName = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.imageName")))
	} else {
...
const checkComposeName = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.composeName")))
	} else {
...
const checkVolumeName = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.volumeName")))
	} else {
...
const checkLinuxName = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.linuxName", ["/\\:*?'\"<>|"])))
	} else {
		const reg = /^[^/\\\"'|<>?*]{1,128}$/
		if (!reg.test(value) && value !== "") {
			callback(new Error(t("commons.rule.linuxName", ["/\\:*?'\"<>|"])))
...
const checkDaemonName = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.daemonName")))
	} else {
...
const checkDatabaseName = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.databaseName")))
	} else {
...
const checkAppName = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.appName")))
	} else {
...
const checkDomain = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.domain")))
	} else {
		const reg =
...
const checkIntegerNumber = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.integer")))
	} else {
		const reg = /^[1-9]\d*$/
		if (!reg.test(value) && value !== "") {
			callback(new Error(t("commons.rule.integer")))
...
const checkFloatNumber = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		...
		const reg = /^\d+(\.\d+)?$/
		if (!reg.test(value) && value !== "") {
			callback(new Error(t("commons.rule.number")))
		} else {
			callback()
		}
	}
...
const checkParamCommon = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.paramName")))
	} else {
...
const checkParamComplexity = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.paramComplexity", [".%@!~_-"])))
	} else {
...
const checkParamUrlAndPort = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.paramUrlAndPort")))
	} else {
		const reg =
...
const checkDoc = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.nginxDoc")))
	} else {
...
export function checkNumberRange(min: number, max: number): FormItemRule {
	return {
		...
		max: max,
		type: "number",
		message: t("commons.rule.numberRange", [min, max])
	}
}
...
export function checkFloatNumberRange(min: number, max: number): FormItemRule {
	let validatorFunc = function (rule: any, value: any, callback: any) {
		if (value === "" || typeof value === "undefined" || value == null) {
			callback(new Error(t("commons.rule.disableFunction")))
		} else {
...
const checkContainerName = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		...
		if (!reg.test(value) && value !== "") {
			callback(new Error(t("commons.rule.containerName")))
		} else {
			callback()
		}
	}
...
const checkLeechExts = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.leechExts")))
	} else {
		const reg = /^[a-zA-Z0-9,]+$/
		if (!reg.test(value) && value !== "") {
			callback(new Error(t("commons.rule.leechExts")))
...
const checkParamSimple = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		...
		if (!reg.test(value) && value !== "") {
			callback(new Error(t("commons.rule.paramSimple")))
		} else {
			callback()
		}
	}
...
const checkFilePermission = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.filePermission")))
	} else {
...
const checkPHPExtensions = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.phpExtension")))
	} else {
		const reg = /^[a-z0-9,_]+$/
		if (!reg.test(value)) {
			callback(new Error(t("commons.rule.phpExtension")))
...
const checkHttpOrHttps = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		callback(new Error(t("commons.rule.paramHttp")))
	} else {
...
const checkPhone = (rule: any, value: any, callback: any) => {
	if (value === "" || typeof value === "undefined" || value == null) {
		...
		if (!reg.test(value) && value !== "") {
			callback(new Error(t("commons.rule.phone")))
		} else {
			callback()
		}
	}
...
export const Rules: CommonRule = {
	...
	requiredSelect: {
		required: true,
		message: t("commons.rule.requiredSelect"),
		trigger: "change"
	},
