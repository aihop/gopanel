...
.main {
	...
	overflow: hidden;
	background:
		radial-gradient(circle at top right, rgba(var(--bg-sidebar-color-rgb) / 0.42), transparent 28%),
		linear-gradient(
			180deg,
			rgba(var(--bg-sidebar-color-rgb) / 0.24) 0%,
			rgba(var(--bg-body-color-rgb) / 0.96) 14%,
			rgba(var(--bg-body-color-rgb) / 1) 100%
		);
