export const codeProjectMessages = {
	zh: {
		code: {
			...
			worktreeDirtyRepositories: "检测到未提交改动：{repositories}。默认不会复制这些改动。",
	...
	en: {
		code: {
			...
			worktreeDirtyRepositories: "Uncommitted changes detected in: {repositories}. They are not copied by default.",
