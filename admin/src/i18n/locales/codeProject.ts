export const codeProjectMessages = {
	zh: {
		code: {
			...
			worktreeIsolationDesc: "为项目中的每个 Git 仓库创建独立分支和目录，避免多个 AI 会话互相覆盖文件",
	...
	en: {
		code: {
			...
			worktreeIsolationDesc: "Creates a dedicated branch and directory for every Git repository so concurrent AI sessions cannot overwrite each other.",
