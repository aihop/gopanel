export default {
	...
	code: {
		...
		projectWorkspace: "Code 项目工作区",
		member: "成员",
		task: "开发任务",
		enterWorkspace: "进入工作区",
		noDesc: "暂无描述",
		newSession: "开启 Code 会话",
		newSessionReady: "新的 Code 会话",
		...
		cancel: "取消",
		retry: "重试",
		sessionCreated: "Code 会话已创建",
		sessionCreateFailed: "Code 会话创建失败",
		...
		openingSession: "正在打开 Code 会话 #{id}...",
