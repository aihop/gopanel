export default {
	securityMonitoring: {
		...
		approvalBoundary: "Risk responses never run automatically. Blocking IPs, changing firewall/WAF rules, or stopping containers and processes requires approval.",
		...
		aiAuthorizationHint: "Only bounded, redacted evidence is sent. This permission is off by default and must be explicitly enabled.",
	...
	database: {
		...
		detachedUserTips: "This user exists on the database server but is not linked locally. Saving will create the local link and synchronize privileges.",
	...
	pipeline: {
		...
		forceDeleteDangerDescription: "This operation cannot be undone. Deletion is still blocked while the pipeline is running, linked to a delivery flow, referenced by delivery history, or its Runner is used by a website.",
		...
		forceDeleteAcknowledge: "I understand this cannot be undone and confirm the pipeline and its rollback history are no longer needed",
		...
		runner_cleanup_failed: "The pipeline was deleted, but Runner container cleanup failed; check the container list manually",
		directory_cleanup_failed: "The pipeline was deleted, but owned directory cleanup failed; check File Management manually",
		actions: "Actions",
